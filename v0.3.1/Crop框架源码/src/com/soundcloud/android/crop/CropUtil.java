...
class CropUtil {
    ...
    @SuppressLint("NewApi") public static int getExifRotation(File imageFile) {
    ...
    @SuppressLint("NewApi") public static boolean copyExifRotation(File sourceFile, File destFile) {
